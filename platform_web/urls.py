...
from platform_web.views.single_views import project_parts_view, part_detail_view
...
urlpatterns = [
    ...
    # Project parts view (inner project view)
    path("project/<slug:slug>/parts/", project_parts_view, name="project_parts_view"),
    path("part/<int:pk>/", part_detail_view, name="part_detail"),
]
